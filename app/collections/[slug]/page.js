...
// Add this function to get all collections
...
export default async function CollectionDetailPage({ params }) {
  ...
  try {
    ...
    const [collectionData, products, allCollections] = await Promise.all([
      getCollection(slug),
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        {/* Related Collections - Now using allCollections */}
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4 text-gray-900">Error Loading Collection</h1>
