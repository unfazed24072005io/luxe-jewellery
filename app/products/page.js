...
export default async function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="w-full bg-gradient-to-br from-gray-50 to-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            {/* Left Column - Image */}
            <div className="relative h-[400px] md:h-[500px] rounded-[25px] overflow-hidden group">
            ...
            <div className="space-y-6">
              ...
              <div className="mt-8">
                <Link href="/products?category=rings">
                  <Button className="relative w-[165px] h-[48px] bg-black hover:bg-gray-900 rounded-[100px] p-0 transition-all duration-300 hover:scale-105">
      ...
      <section className="w-full bg-gradient-to-br from-gray-900 via-black to-gray-900 py-16 md:py-24 relative overflow-hidden">
        {/* Background Elements */}
          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            <div className="flex flex-col items-center gap-6">
              <div className="flex items-center justify-center gap-4">
                <div className="w-0.5 h-16 bg-gradient-to-b from-[#d48b00] to-yellow-600"></div>
                <h2 className="[font-family:'Rische-Demo',Helvetica] font-normal text-white text-3xl md:text-4xl lg:text-[48px] tracking-[-1px] leading-tight">
                  Ready to Glow Up?
                </h2>
              </div>
              
              <p className="[font-family:'Inter',Helvetica] font-medium text-gray-300 text-lg md:text-xl max-w-2xl mx-auto">
                Thousands already have their sparkle. Time to get yours with Diamantra.
              </p>
              
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/products">
                  <Button className="relative w-[165px] h-[48px] bg-[#d48b00] hover:bg-[#c07f00] rounded-[100px] p-0 transition-all duration-500 hover:scale-105 group">
                    <div className="absolute inset-1 rounded-[100px] border-[0.8px] border-solid border-[#fdbe46]" />
                    <span className="relative z-10 [font-family:'Inter',Helvetica] font-semibold text-white text-sm tracking-[0.5px]">
                      Shop Now
                    </span>
                    <div className="absolute top-[22px] left-3 w-1 h-1 bg-yellow-400 rounded-full opacity-75"></div>
                    <div className="absolute top-[22px] right-3 w-1 h-1 bg-yellow-400 rounded-full opacity-75"></div>
                  </Button>
                </Link>
                
                <Link href="/collections">
                  <Button className="relative w-[165px] h-[48px] bg-transparent border-2 border-gray-600 hover:border-gray-500 rounded-[100px] p-0 transition-all duration-300 hover:scale-105">
                    <span className="relative z-10 [font-family:'Inter',Helvetica] font-semibold text-white text-sm tracking-[0.5px]">
                      View Collections
                    </span>
                  </Button>
